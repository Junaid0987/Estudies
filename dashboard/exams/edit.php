...
include "../database.php"; 
    ...
    if(isset($_POST['examedit'])){
        $save = $db->query("update `exams` set `name` ='".$_POST['name']."',`class` = '".$_POST['class']."', `subject` ='".$_POST['subject']."', `type` ='".$_POST['type']."',`status` ='".$_POST['status']."' where `id` = ".$_POST['id'] );
      
      
        if($save){
            $address = $url."/exams/index.php?msg="."User Updated Successfully";
        ...
        <div class="card text-black" style="border-radius: 25px;">
          <div class="card-body p-md-5">
            ...
            <div class="row justify-content-center">
              ...
              <input type="submit" name="examedit" value="Enter Detail" class="btn btn-block btn-primary btn-lg px-5" />
            </form>
            </div>
          </div>
    </div>
